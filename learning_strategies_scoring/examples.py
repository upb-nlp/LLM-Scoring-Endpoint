...
# ===== Multi-text self-explanation examples =====

# Multi-text SE: basic paraphrase of the target sentence (expected overall ~1)
se_mt_data_1 = {
...
print("\n=== Multi-text SE 1 (basic paraphrase, expected overall ~1) ===")
scores = llm_scoring.score(se_mt_data_1, 'selfexplanation_multitext')
print(scores)

# Multi-text SE: brief elaboration with intertext reference (expected overall ~2)
se_mt_data_2 = {
...
print("\n=== Multi-text SE 2 (elaboration + intertext, expected overall ~2) ===")
scores = llm_scoring.score(se_mt_data_2, 'selfexplanation_multitext')
print(scores)

# Multi-text SE: strong elaboration with global integration (expected overall ~3)
se_mt_data_3 = {
...
print("\n=== Multi-text SE 3 (strong elaboration, expected overall ~3) ===")
scores = llm_scoring.score(se_mt_data_3, 'selfexplanation_multitext')
print(scores)

# Multi-text SE: source evaluation and sourcing references (expected high source scores)
se_mt_data_4 = {
    'target_sentence': "Since pre-industrial times (around 1750) the concentration of carbon dioxide (CO2) has increased by around 31 per cent, the concentration of methane (CH4) has increased by around 151 per cent and the concentration of nitrogen oxide (N2O) has increased by around 17 per cent.",
    'context': CLIMATE_MULTITEXT_CONTEXT,
...
print("\n=== Multi-text SE 4 (sourcing + source evaluation, expected overall ~3) ===")
scores = llm_scoring.score(se_mt_data_4, 'selfexplanation_multitext')
print(scores)

# Multi-text SE: off-target / irrelevant content (expected overall ~0)
se_mt_data_5 = {
...
print("\n=== Multi-text SE 5 (off-target, expected overall ~0) ===")
scores = llm_scoring.score(se_mt_data_5, 'selfexplanation_multitext')
print(scores)
